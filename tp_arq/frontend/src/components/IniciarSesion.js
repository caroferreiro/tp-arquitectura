...
export default function IniciarSesion() {
  ...
  const inicioDeSesionPressed = () => {
    ...
    fetch("/api/usuario-log-in", requestOptions)
      .then((response) => {
        if (response.ok) {
  ...
  return (
    <Grid container spacing={1} direction="column" justifyContent="center">
      ...
      <Grid item xs={12} align="center">
        <Button variant="contained" color="primary" onClick={inicioDeSesionPressed} sx={{ fontFamily: 'Poppins', fontWeight: 400 }}>
          Iniciar sesión
        </Button>
      </Grid>
      <Grid item xs={12} align="center">
